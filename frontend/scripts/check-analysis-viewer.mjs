...
check(workspace.includes('appInfo?.channel==="development"')&&workspace.includes('className="editorDevStamp"')&&workspace.includes('String(appInfo?.buildSha||"—").slice(0,8)')&&styles.includes(".editorDevStamp{"),"analysis development build stamp must be conditional, compact and SHA-backed without affecting production");
