...
const xyz=textFile("bridge.xyz","100 200 10\n101 201 11\n102,202,12\n# comment\n");
...
const recordLength=20,pointOffset=227,count=3;
...
pts.forEach((p,index)=>{
  ...
  view.setInt32(o,p[0],true);view.setInt32(o+4,p[1],true);view.setInt32(o+8,p[2],true);view.setUint8(o+15,p[3]);
});
...
assert.equal(lasParsed.metadata.point_format,0);
