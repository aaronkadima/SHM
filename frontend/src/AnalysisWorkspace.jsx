  ...
  return <section className="analysisEditor" aria-label="Workspace de análise">
    <div className="editorTop">
      ...
      <div className="editorTopActions">
        ...
        {selected.length===1&&selected[0]==="cdm_1"&&<button title="Carregar imagem anterior para comparação temporal" onClick={()=>referencePicker.current?.click()}><ImagePlus size={16}/> {referenceFile?"t0: "+referenceFile.name:"Referência t0"}</button>}
