...
import{runSegformerBrowser,runYolov8nCrackSegBrowser}from"./onnxBrowser.js";
...
export function browserEngineSupported(engineId){return engineId==="opencv_crack"||engineId==="cdm_1"||engineId==="segformer_public_crack"||engineId==="yolov8n_public_crack_seg"}
