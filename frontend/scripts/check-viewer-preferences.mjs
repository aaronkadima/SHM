...
const normalized=normalizeViewerPreferences({opacity:1.5,layersOpen:false,comparison:"temporal",pathologyOrder:["cracks","corrosion_rust","cracks",42,""],pathologyOpacity:{cracks:1.4,corrosion_rust:.45,bad:"x","":.3},pathologyLocked:["cracks","cracks",42,""]});
...
check(saveViewerPreferences({opacity:0.55,layersOpen:false,comparison:"original",pathologyOrder:["corrosion_rust","cracks"],pathologyOpacity:{corrosion_rust:.35,cracks:.8},pathologyLocked:["cracks"]},storage)===true,"saveViewerPreferences must succeed with valid storage");
