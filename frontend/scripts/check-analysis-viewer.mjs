...
check(styles.includes(".appShell.settingsShell{height:100vh;height:100dvh;max-height:100dvh;min-height:0;overflow:hidden}")&&styles.includes(".settingsShell .appMain{height:100%;min-height:0;overflow:hidden}"),"settings shell must lock to the dynamic mobile viewport so the footer remains visible");
