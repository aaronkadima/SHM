...
const normalized=normalizeViewerPreferences({opacity:1.5,layersOpen:false,comparison:"temporal"});
...
check(saveViewerPreferences({opacity:0.55,layersOpen:false,comparison:"original"},storage)===true,"saveViewerPreferences must succeed with valid storage");
